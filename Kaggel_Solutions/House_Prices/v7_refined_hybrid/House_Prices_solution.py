...
SUBMISSION_PATH = 'submission_v7_refined_hybrid.csv'
...
def get_pipeline(model):
    ...
    # BACK to OneHot (V4 SOTA), rejecting Ordinal (V6 Regression)
...
def main():
    ...
    # --- V7 Refined Stack (V4 + Golden Feature Only) ---
    ...
    print("Training V7 Refined Hybrid Stack (V4 Base + Single Golden Feature)...")
    stack.fit(X, y)
